...
for ($i = 1; $i <= $totalPage; $i++) {
    ...
    $prevPage = '
            <li class="page-item">
            <a class="page-link" 
            href="http://localhost/TheGioiBDS/public/TrangQuanTri.php?Admin=product_show&page_product=' . $x . '" 
            aria-label="Previous">
    ...
    $nextPage = '
            <li class="page-item">
            <a class="page-link" 
            href="http://localhost/TheGioiBDS/public/TrangQuanTri.php?Admin=product_show&page_product=' . $y . '" 
            aria-label="Next">
    ...
    if ($page_prd == $i) {
        ...
        $listPage .= '<li class="page-item active"><a class="page-link" href="http://localhost/TheGioiBDS/public/TrangQuanTri.php?Admin=product_show&page_product=' . $i . '">' . $i . '</a></li>';
    } else {

        $listPage .= '<li class="page-item"><a class="page-link" href="http://localhost/TheGioiBDS/public/TrangQuanTri.php?Admin=product_show&page_product=' . $i . '">' . $i . '</a></li>';
    }
}
